...
export function EmailView({
  ...
  // Reset smart replies and scroll progress when email changes
  useEffect(() => {
    setSmartReplies([]);
    setScrollProgress(0);
  ...
  return (
    <div className="flex-1 flex flex-col bg-owl-bg relative">
      ...
      {/* ─── EMAIL BODY ─── */}
      <div ref={bodyScrollRef} onScroll={handleBodyScroll} className="flex-1 overflow-y-auto px-6 pt-4 pb-6">
        {hasHtmlContent ? (
          <div
