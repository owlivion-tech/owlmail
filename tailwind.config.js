  ...
  theme: {
    extend: {
      colors: {
        ...
        'owl-accent-2': 'rgb(var(--owl-accent-2) / <alpha-value>)',
      ...
      boxShadow: {
        'owl': '0 4px 20px rgba(0, 0, 0, 0.6)',
        'owl-lg': '0 8px 40px rgba(0, 0, 0, 0.75)',
        'owl-accent': '0 4px 20px rgba(204, 68, 255, 0.40)',
        'owl-accent-lg': '0 8px 40px rgba(204, 68, 255, 0.55)',
        'owl-glow': '0 0 32px rgba(204, 68, 255, 0.18)',
        'owl-pink': '0 4px 20px rgba(255, 0, 128, 0.35)',
      },
      animation: {
