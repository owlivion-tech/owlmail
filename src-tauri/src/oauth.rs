...
<html><head><meta charset="UTF-8"><title>OwlMail</title></head>
...
<p style="color:#a1a1aa;font-size:15px;margin:0 0 32px;line-height:1.5;">Please close this window and try again<br>from OwlMail.</p>
</div>
</body></html>"#;
                ...
                if let Some((_, code)) = params.iter().find(|(k, _)| *k == "code") {
                    ...
                    let success_html = concat!(
                        "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>OwlMail</title></head>",
                        ...
                        "<img src='https://owlivion.com/mail/owlivion-logo.png' alt='OwlMail' width='200' ",
                        ...
                        "Your Google account has been connected to OwlMail.</p>",
                        "</div></body></html>"
                    );
